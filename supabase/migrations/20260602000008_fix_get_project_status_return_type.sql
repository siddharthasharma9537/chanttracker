-- Fix get_project_status RPC return type from JSONB to JSON
-- The json_agg() function returns JSON, not JSONB
-- PostgreSQL requires exact type matching between RETURNS and SELECT
